...
| `/`, `/dashboards`, `/_dashboards` | Server-rendered Assistant dashboard home, dashboard selection/creation, layout editing, compact dashboard chat, instance-id dashboard widget summary/detail/settings fragments, personal planner/calendar/habit/reminder/context fragments, notes/file-note fragments, project artifact fragments, agent operational widget output/Work Area mini-view fragments, and compatibility widget fragments. Work Area browser fragments live under agent detail routes. | [`AvatarDashboardController`](../../src/main/java/io/mindspice/magenta2/api/web/AvatarDashboardController.java), [`Assistant dashboard fragments`](../technical/avatar-dashboard-fragments.md) |
| `/agents/_detail/{agentId}/work-areas` | Agent-detail Work Area browser and editor fragments guarded by Work Area owner. | [`OrchestrationController`](../../src/main/java/io/mindspice/magenta2/api/web/OrchestrationController.java), [`Assistant dashboard fragments`](../technical/avatar-dashboard-fragments.md) |
