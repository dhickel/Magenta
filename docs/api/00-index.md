...
| `/api/work-areas` | Agent/project Work Area metadata plus confined browse, preview/download, text edit, directory, rename, delete, and mark controls. | [`WorkAreaController`](../../src/main/java/io/mindspice/magenta2/api/web/WorkAreaController.java) |
