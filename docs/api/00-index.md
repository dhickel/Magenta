...
| `/`, `/dashboards`, `/_dashboards` | Server-rendered Assistant dashboard home, dashboard selection/creation, layout editing, compact dashboard chat, and dashboard widget fragments. Work Area browser fragments live under agent detail routes. | [`AvatarDashboardController`](../../src/main/java/io/mindspice/magenta2/api/web/AvatarDashboardController.java), [`Assistant dashboard fragments`](../technical/avatar-dashboard-fragments.md) |
