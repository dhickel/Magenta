...
| `/avatar` | Server-rendered Avatar shell and HTMX fragments for tabs, dashboard layout editing, compact Avatar chat, outputs, and Work Area explorer flows. | [`AvatarDashboardController`](../../src/main/java/io/mindspice/magenta2/api/web/AvatarDashboardController.java), [`Avatar dashboard fragments`](../technical/avatar-dashboard-fragments.md) |
| `/skills` | Minimal server-rendered Agent Skills shell/fragments used for phase-04 endpoint integration and phase-05 UI foundation. | [`SkillFragments`](../../src/main/java/io/mindspice/magenta2/api/web/SkillFragments.java) |
