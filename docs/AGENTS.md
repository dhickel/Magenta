...
- If documentation and code diverge, record the mismatch in the current task output and create or update a tracking artifact in `.internal-dev/bugs/` or the active task notes.
