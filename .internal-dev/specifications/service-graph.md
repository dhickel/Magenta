...
| SVC-20260526-02 | Runtime prompt/context assembly | Workspace `AGENTS.md` resolver services | active | Prompt/context assembly consumes runtime `AGENTS.md` layers from workspace/runtime services scoped to bound roots and active paths. | Prompt assembly must not perform ad-hoc filesystem traversal or independent root resolution; confinement and resolution stay service-owned. | Prompt/context tests plus resolver service tests for path-change behavior and conflict precedence messaging. | `DECISION-20260526-02` |
