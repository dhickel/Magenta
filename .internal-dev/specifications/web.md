...
| WEB-20260525-02 | Dashboard visual contract | active | Use dense panels, compact controls, thin blue-gray borders, low shadow, small radii, semantic chips, compact headings, and useful first-viewport density. | `/`, `/manage`, `/agents` | Avoid loose widget collages, hero sections, oversized personal-product cards, browser-default controls, and nested decorative cards. | Compare screenshots against `/manage` and `/agents`. | `DECISION-20260522-07` | `simplypages-avatar-layout-and-editing.md` |
