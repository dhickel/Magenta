...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ARCH-20260523-01 | Avatar Work Areas and dashboard refactor. | Treat Work Areas as runtime-owned metadata around confined agent/project directories while keeping Avatar layout and planner data in `avatar.sqlite`. | active | unassigned | .internal-dev/plans/avatar-agent-ui-refactor/implementation-plan.md | 2026-06-22 | Planned direction: selected Work Area becomes assignment `workspace/`, broader owned root becomes `root/`, and output routing is explicit assignment metadata. |
