...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DECISION-20260522-06 | Agent operational tools use existing Spring AI tool registration, exact approved-tool names, current orchestration context, and Avatar identity checks instead of a separate operational runtime. | active | unassigned | .internal-dev/plans/avatar-dashboard-sprint/phase-03-agent-workspace-tooling.md | 2026-05-22 | .internal-dev/changelogs/2026-05-22-agent-operational-tools.md | 2026-06-21 | PLAN/TASK drafting modes exclude `agent_` and `avatar_` tools; side-panel agent chat installs context inside the queued chat turn. |
