...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DECISION-20260524-03 | Avatar Work Area file exploration uses Magenta-local HTMX details/list fragments with service-owned filesystem confinement, not a reusable card/module explorer. | active | unassigned | .internal-dev/changelogs/2026-05-24-workspace-file-explorer-rewrite.md | 2026-05-24 | .internal-dev/knowledge/workspace-file-explorer-details-list-rewrite.md | 2026-06-23 | Future file explorer work should preserve stable table columns, a separate inspector, OOB table/inspector/modal refreshes, and direct service validation for all paths and destinations. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DECISION-20260523-04 | Long-running email-coordinated work records inbound AgentMail instructions in a repo-local ledger before dispatching implementation. | superseded | unassigned | prior AgentMail intake workflow | 2026-05-23 | 2026-05-24 | Direct AgentMail daemon/wait dispatch through `mailctl status`, `mailctl next`, and `mailctl wait`; no repo-local email ledger. | .internal-dev/knowledge/email-followup-wait-workflow.md | The repo-local ledger was removed as redundant and confusing. The active workflow is direct daemon monitoring, immediate main-thread interpretation, delegated execution when useful, gate emails, and low-token waiting. |

## Review Log

| reviewed_on | reviewer | outcome | notes |
| --- | --- | --- | --- |
| 2026-05-24 | codex | superseded | Removed the repo-local email coordination ledger; AgentMail daemon/wait state is now the direct workflow for inbound instructions and gate-report listening. |
| 2026-05-24 | codex | updated | Added the Work Area file explorer details/list decision after the final rewrite replaced card/module assumptions with Magenta-local HTMX fragments and service-owned path confinement. |
...
| 2026-05-23 | codex | updated | Added durable AgentMail ledger coordination decision after Dwight requested persistent email intake during remote work; superseded on 2026-05-24 by direct daemon/wait dispatch. |
