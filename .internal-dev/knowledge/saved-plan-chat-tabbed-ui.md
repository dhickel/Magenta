...
- Manual editor saves can preserve chat continuity by appending a concise user-role context message summarizing changed scalar fields before the next saved-plan chat response.
