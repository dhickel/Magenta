...
| `03-execution-history-streams` | `public-alpha-remediation/execution-history-streams` | in_progress | Codex | subplan-01 passed | Owns public execution contract and transcript preservation. |
...
| bug-06 | `03-execution-history-streams` | validating | `subplan-02-transcript-preservation.md` | implementer: `mvn -Dtest=ChatServiceTest,PlanServiceTest test`; stale copy search for destructive execution-clearing language passed; parent validation pending | pending |
