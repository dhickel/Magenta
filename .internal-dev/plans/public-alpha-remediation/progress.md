...
| bug-09 | `02-workspace-tools-outputs` | in_progress | `subplan-02-file-tool-workspace-scope.md` | implementer: `mvn -Dtest=AgentFileToolServiceTest,ChatToolRegistryTest,AgentShellToolServiceTest,OrchestrationRuntimeTest test`; confirmed active workspace/output/current-project file scope, unrelated runtime/agent/project denial, no-context data-root fallback, traversal/symlink protection, and updated model-visible descriptions; validation pending | pending |
