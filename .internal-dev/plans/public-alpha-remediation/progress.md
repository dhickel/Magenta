...
| `04-workflow-authoring-runtime-js` | `public-alpha-remediation/workflow-authoring-runtime-js` | in_progress | Codex | subplan-01 passed | Must preserve HTMX-first CRUD and narrow JS graph behavior. |
