...
| --- | --- | --- | --- | --- | --- |
| `01-security-access-control` | `public-alpha-remediation/security-access-control` | in_progress | Codex | subplans 01-03 passed | Subplan 04 active next; full domain validation still pending. |
