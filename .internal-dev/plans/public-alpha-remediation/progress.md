...
| `03-execution-history-streams` | `public-alpha-remediation/execution-history-streams` | in_progress | Codex | subplan-05 passed | Owns public execution contract, transcript preservation, SSE events, job run submission, and schedule/reaction template validation. |
