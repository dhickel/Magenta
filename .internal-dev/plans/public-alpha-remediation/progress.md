...
| --- | --- | --- | --- | --- | --- |
| `01-security-access-control` | `public-alpha-remediation/security-access-control` | planned | unassigned | planned | Blocks public exposure and tool/runtime security domains. |
...
| --- | --- | --- | --- | --- | --- |
| bug-01 | `01-security-access-control` | planned | `subplan-01-auth-csrf-gate.md` | pending | pending |
